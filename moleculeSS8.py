...
def main():
    ...
    seq_tokenizer = BertTokenizerFast.from_pretrained(model_name, do_lower_case=False, max_length = max_length)
...
# we don't want to pass this to the model
    ...
    train_dataset = SS8Dataset(train_seqs_encodings, train_labels_encodings)
    val_dataset = SS8Dataset(val_seqs_encodings, val_labels_encodings)
    test_dataset = SS8Dataset(test_seqs_encodings, test_labels_encodings)
...
#"""10. Define the evaluation metrics"""
    ...
    output_dir='./results/ss3/setLength',          # output directory
    ...
    run_name="ProBert-BFD-SS3-setLength",      # experiment name
...
#save the model
    ...
    trainer.save_model('prot_bert_bfd_ss3_setLength/')

    seq_tokenizer.save_pretrained('prot_bert_bfd_ss8_setLength/')
